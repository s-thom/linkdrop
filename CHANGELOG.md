...
## [Unreleased](https://github.com/s-thom/linkdrop/compare/v2.1.0...HEAD) - DATE

## [v2.1.0](https://github.com/s-thom/linkdrop/compare/v2.0.2...v2.1.0) - 2026-03-01

### Changed

- Moved project from Remix to Astro.
- Changing password now logs out all sessions.
